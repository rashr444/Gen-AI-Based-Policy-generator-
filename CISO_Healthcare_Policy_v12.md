...
-   --Policy Enforcement:-- Section 8 is added, detailing the consequences of non-compliance (disciplinary action, termination, legal consequences). It outlines a process for investigating violations and determining appropriate actions, ensuring the policy is more than just a statement of intent.  The Introduction now includes a statement that failure to comply will have consequences.
